            ...
            const response = await fetch("/api/openai", {
                ...
                body: JSON.stringify({
                    messages: [
                        ...
                        { role: newMessage.role, content: `User Provided Cards: ${JSON.stringify(selectedCards)} User Message: ${newMessage.content}` },
                    ],
                }),
            });
